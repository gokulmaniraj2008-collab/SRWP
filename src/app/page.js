      ...
      <div style={{ padding: "20px 16px 0" }}>
        ...
        {activeTab === "connect" && (
          <div>
            ...
            {[
              { icon: "guide",   title: "Explore Members",  desc: "Search GGE members by @username or name across India", action: "explore" },
              ...
              <div key={i} onClick={() => f.action === "explore" && setPage && setPage("explore")} style={{ background: C.white, borderRadius: 14, padding: "14px 16px", border: `1px solid ${C.gray100}`, marginBottom: 10, display: "flex", alignItems: "center", gap: 14, cursor: f.action ? "pointer" : "default" }}>
                <div style={{ width: 42, height: 42, background: f.action ? C.black : C.gray100, borderRadius: 11, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                  <Icon n={f.icon} size={18} color={f.action ? "#fff" : C.gray400} />
                </div>
                <div style={{ flex: 1 }}>
