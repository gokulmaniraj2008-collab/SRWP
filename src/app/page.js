...
const ConstitutionPage = ({ onBack, user }) => {
  ...
  const rights = [
    ...
    },
    {
      ...
      articles: [
        ...
        { no: "POCSO", title: "Child Protection (POCSO)", desc: "Any sexual offence against a child under 18 is punishable under POCSO Act. Report immediately to police or Childline 1098." },
    ...
    },
    {
      ...
      articles: [
        ...
        { no: "IT Act", title: "Cyber Crime Rights", desc: "Online fraud, identity theft, cyber harassment are criminal offences. Report at cybercrime.gov.in or call 1930." },
  ...
  const helplines = [
    { label: "Women Helpline",   number: "1091",          color: "#7c3aed" },
    { label: "Police",           number: "100",           color: C.red },
    { label: "Ambulance",        number: "108",           color: C.red },
    { label: "Anti Corruption",  number: "1064",          color: "#d97706" },
    { label: "Consumer",         number: "1800-11-4000",  color: "#0891b2" },
    { label: "Cyber Crime",      number: "1930",          color: "#0891b2" },
    { label: "Child Helpline",   number: "1098",          color: C.green },
    { label: "RTI Helpline",     number: "011-24606655",  color: C.green },
    { label: "Legal Aid",        number: "15100",         color: C.black },
    { label: "Senior Citizen",   number: "14567",         color: "#d97706" },
  ];
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "Nunito, sans-serif", maxWidth: 480, margin: "0 auto", paddingBottom: 90 }}>
      ...
      <div style={{ padding: "16px 16px 0" }}>
        ...
        {activeTab === "helplines" && (
          <div>
            <div style={{ background: C.redBg, borderRadius: 14, padding: "13px 16px", border: `1px solid #fca5a5`, marginBottom: 16, display: "flex", gap: 10, alignItems: "center" }}>
              <Icon n="info" size={18} color={C.red} />
              <p style={{ fontSize: 13, color: C.red, fontWeight: 600, margin: 0, lineHeight: 1.5 }}>Emergency? Call immediately — all numbers free, 24 hours.</p>
            </div>
            {helplines.map((h, i) => (
              <a key={i} href={`tel:${h.number}`} style={{ textDecoration: "none" }}>
                <div style={{ background: C.white, borderRadius: 14, padding: "15px 16px", border: `1px solid ${C.gray100}`, marginBottom: 10, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <div>
                    <p style={{ fontFamily: "Poppins, sans-serif", fontSize: 14, fontWeight: 700, color: C.black, margin: "0 0 2px" }}>{h.label}</p>
                    <p style={{ fontSize: 14, color: h.color, fontWeight: 800, margin: 0 }}>{h.number}</p>
                  </div>
                  <div style={{ width: 42, height: 42, background: h.color + "15", borderRadius: 11, display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <Icon n="phone" size={18} color={h.color} />
                  </div>
                </div>
              </a>
            ))}
